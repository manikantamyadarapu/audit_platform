  ...
  return (
    ...
    >
      <div className={cn('flex items-start gap-3 px-8 pb-8 pt-9', sidebarCollapsed && 'flex-col items-center px-4')}>
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-[#37c96b] to-[#1fa64f] text-white shadow-lg shadow-green-500/20">
          <ShieldCheck className="h-5 w-5" strokeWidth={1.8} />
        </div>
        {!sidebarCollapsed ? (
          <>
            <div className="min-w-0 flex-1">
              <p className="truncate text-lg font-bold tracking-tight text-slate-950">HASS Audit</p>
      ...
      {!sidebarCollapsed ? (
        <div className="m-7 rounded-full border border-slate-200 bg-white px-4 py-3 shadow-[0_10px_28px_rgba(15,23,42,0.08)]">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="truncate text-xs text-slate-600">admin@hass.com</p>
            </div>

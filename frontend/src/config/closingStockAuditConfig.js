...
export const CLOSING_STOCK_AUDIT_CONFIG = {
  ...
  pageSubtitle:
    'Upload Sales, Purchases, Current Year Opening Quantity, Previous Year Closing Stock (Dia/Eme/…), MR, and DC. Opening Qty from Opening Balance; Opening Amount from each product’s Closing stock Amt — then Rule Book places them on Closing Stock.',

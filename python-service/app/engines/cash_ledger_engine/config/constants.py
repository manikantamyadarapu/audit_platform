...
# Bank contra-account detection (case-insensitive via normalize_contra_account)
# Phrases matched as substrings.
BANK_ACCOUNT_PHRASES: Final = frozenset({
    'bank limited',
    'bank ltd',
    'cash credit account',
    'cash credit',
...
# Single tokens matched as whole words after tokenization.
BANK_ACCOUNT_TOKENS: Final = frozenset({
    'bank',
    'od',
})

# Well-known bank names / acronyms (may appear without the word "bank").
BANK_NAME_TOKENS: Final = frozenset({
    'hdfc',
    'icici',
    'sbi',
    'pnb',
...
BANK_NAME_PHRASES: Final = frozenset({
    'state bank of india',
    'state bank',
    'union bank',
